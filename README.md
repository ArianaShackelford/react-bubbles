...
Tokens are used for authentication, and insuring a modicum of security for sending info between the user and the server.

- [ ] What steps can you take in your web apps to keep your data secure?

Use tokens, axiosWithAuth, local storage, and privat routes
